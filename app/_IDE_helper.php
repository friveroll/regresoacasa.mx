 ...
 class App extends Illuminate\Support\Facades\App{
	 ...
	 */
	 public static function setRequestForConsoleEnvironment(){
		self::$root->setRequestForConsoleEnvironment();
	 }
 ...
 class Artisan extends Illuminate\Support\Facades\Artisan{
	 ...
	 */
	 public static function setDispatcher($dispatcher){
		self::$root->setDispatcher($dispatcher);
	 }
 ...
 class Auth extends Illuminate\Support\Facades\Auth{
	 ...
	 */
	 public static function once($credentials = array()){
		return self::$root->once($credentials);
	 }
	 ...
	 */
	 public static function basic($field = 'email', $request = null){
		return self::$root->basic($field, $request);
	 }
	 ...
	 */
	 public static function onceBasic($field = 'email', $request = null){
		return self::$root->onceBasic($field, $request);
	 }
	 ...
	 */
	 public static function setRequest($request){
		return self::$root->setRequest($request);
	 }
 ...
 class DB extends Illuminate\Support\Facades\DB{
	 ...
	 */
	 public static function getDoctrineColumn($table, $column){
		return self::$root->getDoctrineColumn($table, $column);
	 }
	 ...
	 */
	 public static function getDoctrineSchemaManager(){
		return self::$root->getDoctrineSchemaManager();
	 }
	 ...
	 */
	 public static function getDoctrineConnection(){
		return self::$root->getDoctrineConnection();
	 }
 ...
 class Eloquent{
	 ...
	 */
	 public static function update($attributes = array()){
		return self::$root->update($attributes);
	 }
 ...
 class Form extends Illuminate\Support\Facades\Form{
	 ...
	 */
	 public static function getValueAttribute($name, $value = null){
		return self::$root->getValueAttribute($name, $value);
	 }
 ...
 class Hash extends Illuminate\Support\Facades\Hash{
	 ...
	 */
	 public static function needsRehash($hashedValue, $options = array()){
		return self::$root->needsRehash($hashedValue, $options);
	 }
 ...
 class Html extends Illuminate\Support\Facades\Html{
	 ...
	 */
	 public static function script($url, $attributes = array()){
		return self::$root->script($url, $attributes);
	 }
	 ...
	 */
	 public static function style($url, $attributes = array()){
		return self::$root->style($url, $attributes);
	 }
	 ...
	 */
	 public static function mailto($email, $title = null, $attributes = array()){
		return self::$root->mailto($email, $title, $attributes);
	 }
	 ...
	 */
	 public static function obfuscate($value){
		return self::$root->obfuscate($value);
	 }
 ...
 class Input extends Illuminate\Support\Facades\Input{
	 ...
	 */
	 public static function getTrustedHeaderName($key){
		return self::$root->getTrustedHeaderName($key);
	 }
 ...
 class Mail extends Illuminate\Support\Facades\Mail{
	 ...
	 */
	 public static function queue($view, $data, $callback, $queue = null){
		self::$root->queue($view, $data, $callback, $queue);
	 }
	 ...
	 */
	 public static function queueOn($queue, $view, $data, $callback){
		self::$root->queueOn($queue, $view, $data, $callback);
	 }
	 ...
	 */
	 public static function later($delay, $view, $data, $callback, $queue = null){
		self::$root->later($delay, $view, $data, $callback, $queue);
	 }
	 ...
	 */
	 public static function laterOn($queue, $delay, $view, $data, $callback){
		self::$root->laterOn($queue, $delay, $view, $data, $callback);
	 }
	 ...
	 */
	 public static function handleQueuedMessage($job, $data){
		self::$root->handleQueuedMessage($job, $data);
	 }
	 ...
	 */
	 public static function setLogger($logger){
		return self::$root->setLogger($logger);
	 }
	 ...
	 */
	 public static function setQueue($queue){
		return self::$root->setQueue($queue);
	 }
 ...
 class Redirect extends Illuminate\Support\Facades\Redirect{
	 ...
	 */
	 public static function guest($path, $status = 302, $headers = array(), $secure = null){
		return self::$root->guest($path, $status, $headers, $secure);
	 }
	 ...
	 */
	 public static function intended($default, $status = 302, $headers = array(), $secure = null){
		return self::$root->intended($default, $status, $headers, $secure);
	 }
 ...
 class Redis extends Illuminate\Support\Facades\Redis{
	 ...
	 */
	 public static function connection($name = 'default'){
		return self::$root->connection($name);
	 }
 ...
 class Response{
	 ...
	 */
	 public static function view($view, $data = array(), $status = 200, $headers = array()){
		return self::$root->view($view, $data, $status, $headers);
	 }
 ...
 class Route extends Illuminate\Support\Facades\Route{
	 ...
	 */
	 public static function callCloseFilter($request, $response){
		return self::$root->callCloseFilter($request, $response);
	 }
 ...
 class Session extends Illuminate\Support\Facades\Session{
	 ...
	 */
	 public static function __construct($storage = null, $attributes = null, $flashes = null){
		self::$root->__construct($storage, $attributes, $flashes);
	 }
	 ...
	 */
	 public static function migrate($destroy = false, $lifetime = null){
		self::$root->migrate($destroy, $lifetime);
	 }
